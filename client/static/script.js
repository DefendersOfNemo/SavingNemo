$(function() {
    ...
    $('#dropdown_menu_output_type_name').change( function () {
        ...
        if (query_field10 == "All"){
            ...
            select.append('<select id ="dropdown_menu_analysis_type_name" class="form-control"><option value="">Please select Temperature frequency</option><option value="Daily">Daily</option><option value="Weekly">Weekly</option><option value="Monthly">Monthly</option><option value="Yearly">Yearly</option>')
